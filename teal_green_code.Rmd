...
df_noabx <- tidy_poly_model(fit_noabx,  "No antibiotics")
...
grand_df <- bind_rows(
    ...
    mutate(
        exposure_lbl = case_when(
            ...
            term == "poly_cat5–9"  ~ "5–9 medications",
            term == "poly_cat≥10"  ~ "≥10 medications",
            term == "poly_cat_no_abx0"    ~ "0 medications",
            term == "poly_cat_no_abx1–4"  ~ "1–4 medications (ref)",
            term == "poly_cat_no_abx5–9"  ~ "5–9 medications",
            term == "poly_cat_no_abx≥10"  ~ "≥10 medications",
            TRUE                   ~ term
        )
    ) %>%
